        ...
        <section className='auth-right-section'>
            ...
            <div className='z-10 relative lg:mt-4 lg:mb-16'>
                ...
                <blockquote className='auth-blockquote'>
                    From big-picture market trends to detailed stock analysis, Signalist delivers the context needed for smarter trading decisions.
                ...
                <div className='flex items-center justify-between'>
                    ...
                    <div>
                        <cite className='auth-testimonial-author'> ~ Stephen Johnson</cite>
