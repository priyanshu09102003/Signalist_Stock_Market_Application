...
import CoinsPagination from '@/components/CryptoComponents/CoinsPagination';
...
const CoinsPage = async ({ searchParams }: NextPageProps) => {
  ...
  const columns: DataTableColumn<CoinMarketData>[] = [
    ...
    {
      header: 'Price',
      cellClassName: 'price-cell_two',
      cell: (coin) => formatCurrency(coin.current_price),
    },
    {
      header: '24h Change',
      cellClassName: 'change-cell_two',
      cell: (coin) => {
    ...
    <>
        ...
        <main id='coins-page'>
          <div className="content">
            <h4 className='font-semibold'>All Coins</h4>
